...
public class RuntimeStats
{
    ...
    public RuntimeStats(RuntimeCharacter character)
    {
        BaseStats = character.BasedOfCharacter.baseStats;
        AdvancedStats = character.BasedOfCharacter.advancedStats;
    ...
    public float Energy { get { return _energy; } set { _energy = MathF.Min(value, Adv.MaxEnergy); } }
